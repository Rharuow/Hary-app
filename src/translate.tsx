  ...
  US: {
    ...
    aboutMe: (
      <p className="text-center mb-0 bg-secondary text-dark fw-bold p-2 text-justify rounded-top">
        ...
        joined at{" "}
        <strong className="text-yellow">Tootz Soluções Tecnológicas</strong> in
  ...
  BR: {
    ...
    aboutMe: (
      <p className="text-center mb-0 bg-secondary text-dark fw-bold p-2 text-justify rounded-top">
        ...
        ferramenta educacional digital, meu interesse pela programação surgiu, e
        então, programei pela primeira vez um sistema monolítico utilizando{" "}
        <strong className="text-yellow">Ruby on Rails</strong>. Devido ao pouco
        tempo e recursos, a ferramenta não foi concluída. Então, após estudar e
        criar alguns projetos com{" "}
        <strong className="text-yellow">WordPress</strong>, e com a finalidade
        de buscar experiências reais na área de desenvolvimento web, resolvi me
        ...
        desafiador e sentia que não havia evolução como desenvolvedor realizando
        ...
        na <strong className="text-yellow">Tootz Soluções Tecnológicas</strong>{" "}
